...
a persistence unit "prueba63litumaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63lituma/pom.xml":
...
artifact ("prueba63lituma.war") is already built. You can build
